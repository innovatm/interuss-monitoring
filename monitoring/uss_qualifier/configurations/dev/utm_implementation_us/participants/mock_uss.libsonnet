{
  ...
  local_env: {
    ...
    flight_planner: {
      participant_id: 'mock_uss',
      v1_base_url: 'https://mock.dss.uspacekeeper.com/mock_uss_scdsc_interaction_log/flight_planning/v1',
    },
    ...
    test_env_version_provider: {
      ...
      interuss: {
        base_url: 'https://mock.dss.uspacekeeper.com/mock_uss_scdsc_interaction_log/versioning',
      },
    },
  }
}
