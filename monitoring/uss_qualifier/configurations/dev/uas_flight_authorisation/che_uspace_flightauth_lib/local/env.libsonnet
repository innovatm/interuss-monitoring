function(participants) {
  // This file contains environmental (non-baseline) parameters for the che_uspace_flightauth.jsonnet test configuration for the standard local CI environment.
